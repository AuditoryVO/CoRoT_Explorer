;Coordinates Explorer bounds(0, 0, 0, 0)
;Adrián García Riber
;2024
<Cabbage>
form caption("BINAURAL CoRoT EXPLORER") size(900,715), colour(0,0,0), pluginID("BINAURAL CoRoT EXPLORER")
...
if gkmode == 1 then ; ---------------------------binaural output--------------------------------------
    ;Loading HRTF
...
;	Splot sprintfk "file(%s)", "Init2.png"
;	chnset Splot, "Star"	
;	imagefree giPlot
